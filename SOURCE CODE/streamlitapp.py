...
if st.session_state.page == "predictor":
    ...
    # checking whether any invalid value was entered
    invalid_input = False
    ...
    for feature in all_feature_names:
        ...
        #-------------------------------------------------------------------
            ...
            value = st.text_input("Living Area (ft²)",value="0.00")
            try:
                value = float(value)
        ...
        #-------------------------------------------------------------------
            ...
            value = st.text_input( "Renovated Living Area (ft²)",value="0.00")
            try:
                value = float(value)
        ...
        #-------------------------------------------------------------------
            ...
            value = st.text_input("Renovated Lot Area (ft²)",value="0.00")
            try:
                value = float(value)
        ...
        #-------------------------------------------------------------------
            ...
            value = st.text_input("Area of the house(excluding basement) (ft²)",value="0.00")
            try:
                value = float(value)
        ...
        #-------------------------------------------------------------------
            ...
            value = st.text_input("Lot Area (ft²)",value="0.00")
            try:
                value = float(value)
        ...
        #-------------------------------------------------------------------
            ...
            value = st.text_input("Latitude",value="0.00")
            try:
                value = float(value)
